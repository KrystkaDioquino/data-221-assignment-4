...
**Question 1: Dataset Exploration and Understaning**

**Question 2: Decision Tree Model Using Entropy**

**Question 3: Controlling Tree Complexity and Interpretability**

**Question 4: Neaural Network for Binary Classification**

**Question 5: Model Evaluation and Comparison**

**Question 6: Convolutional Neaural Network with Built-in Dataset**
